...
from .views import UserSignUp, PasswordChangeView, login_user, logout_user, ResetPasswordView, ActivateAccount#, PasswordResetConfirmView, PasswordResetCompleteView
